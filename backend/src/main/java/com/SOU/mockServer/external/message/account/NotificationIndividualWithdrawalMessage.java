...
public class NotificationIndividualWithdrawalMessage extends Message {
    ...
    public NotificationIndividualWithdrawalMessage(CommonFieldMessage commonFieldMessage,
        NotificationIndividualWithdrawalMessageDto niwmDto) {
        this.commonFieldMessage = commonFieldMessage;
        this.commonFieldMessage.getTotalMessageLength().set(getTotalLength());

        this.stockAccountNumber = new Field<>(LENGTH_STOCK_ACCOUNT_NUMBER,
            niwmDto.getStockAccountNumber());
        ...
        this.receiverBankAccountNumber = new Field<>(LENGTH_RECEIVER_ACCOUNT_NUMBER,
            niwmDto.getReceiverBankAccountNumber());
        ...
        this.memberCompanyTranDate = new Field<>(LENGTH_MEMBER_COMPANY_TRAN_DATE,
            niwmDto.getMemberCompanyTranDate());
        this.memberCompanyAccountNumber = new Field<>(LENGTH_MEMBER_COMPANY_ACCOUNT_NUMBER,
            niwmDto.getMemberCompanyAccountNumber());
        this.memberCompanyTranId = new Field<>(LENGTH_MEMBER_COMPANY_TRAN_ID,
            niwmDto.getMemberCompanyTranId());
        this.memberCompanyCancelTranId = new Field<>(LENGTH_MEMBER_COMPANY_CANCEL_TRAN_ID,
            niwmDto.getMemberCompanyCancelTranId());
